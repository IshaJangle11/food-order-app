...
let Footer = () => {
    return <div className={footerCss.footer}>
        <div className={footerCss.innerFooter}>
            <div className={footerCss.section1}>
                <div className={footerCss.logoBox}>Foodie</div>
            ...
            <div className={footerCss.section2}>
                <div className={[footerCss.box1, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>ABOUT Foodie</div>
                ...
                <div className={[footerCss.box2, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>FOODIVERSE</div>
                    <a href="" className={footerCss.boxOpt}>Foodie</a>
                    <a href="" className={footerCss.boxOpt}>Feeding India</a>
                    <a href="" className={footerCss.boxOpt}>Hyperpure</a>
                    <a href="" className={footerCss.boxOpt}>Foodiland</a>
                </div>
                <div className={[footerCss.box3, footerCss.box].join(' ')}>
                    ...
                    <a href="" className={footerCss.boxOpt}>Foodie For Work</a>
                </div>
            ...
            <div className={footerCss.section3}>
                By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2022 © Foodie™ Ltd. All rights reserved.
            </div>
        </div>
    </div>
}
