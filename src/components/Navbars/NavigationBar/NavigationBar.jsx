...
import shopp from '/icons/shopping-cart.jpg'
            ...
            <div className={css.rightSide}>
                ...
                {loggedIn ? (<div className={css.menuItem}>
                    ...
                    <div className={css.menu} style={{display: menuDisplay ? "block" : ""}}>
                        <Link to='' className={css.menuItemLinkTxt}>
                ...
                (<>
                    ...
                    <Link to='/mycart' className={css.appTxt}>Cart </Link>
                    <img src={shopp} alt="shopping cart" className={css.img} />
                </>)}
            </div>
        </div>
